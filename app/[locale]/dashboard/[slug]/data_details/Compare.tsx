                          ...
                          >
                            ...
                            <PopoverContent className="w-[280px] sm:w-[320px]">
                              <div className="space-y-4">
                                ...
                                <div className="space-y-4">
                                  <div>
                                    <Label className="mb-2 block">{t('year')}</Label>
                                    <Select
                                      onValueChange={(value) =>
                        ...
                        <div className="flex w-full items-start gap-2 text-sm">
                          <div className="grid gap-2">
                            ...
                            <div className="flex items-center gap-2 leading-none text-muted-foreground">
                              {t('yearlySummary', { year: formatYearRange(selectedYears) })}
                            </div>
                            <div className="leading-none text-muted-foreground">
                              {t('analyzingData', { year: formatYearRange(selectedYears) })}
                            </div>
                          </div>
                        </div>
                      </CardFooter>
                      ...
                      <CardContent>
                        <Tabs defaultValue="income" className="mb-8">
                          <TabsList className="grid grid-cols-1 sm:grid-cols-3 max-w-xl mx-auto">
                            <TabsTrigger value="income">{t('labels.income')}</TabsTrigger>
                            <TabsTrigger value="expense">{t('labels.expenses')}</TabsTrigger>
                            <TabsTrigger value="tax">{t('labels.tax')}</TabsTrigger>
                          </TabsList>
